const String manganese = 'Manganês';

const List<String> titles = <String>[
  'Manganês puro',
  '70% Manganês e 30% Silicio',
  '80% Manganês e 20% Ferro',
  '98,5% Aluminio e 1,5% Manganês'
];

/*const List<String> texts = <String>[
  'Manganes é um metal que é quebradiço',
  'Manganes+Silicio é uma liga',
  'Manganes+Ferro é uma liga',
  'Aluminio+Manganês é uma liga'
];*/

const String manganeseImg = 'assets/manganes.jpg';
const List<String> imgPaths = <String>[
  manganeseImg,
  'assets/simn.jpg',
  'assets/femg.png',
  'assets/almn.jpeg',
